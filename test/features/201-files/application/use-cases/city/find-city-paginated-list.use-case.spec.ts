...
describe('FindCityWithPaginatedListUseCase', () => {
  let useCase: FindCityPaginatedListUseCase;
  ...
  beforeEach(async () => {
    ...
    useCase = module.get<FindCityPaginatedListUseCase>(
      FindCityPaginatedListUseCase,
    );
  ...
  describe('execute', () => {
    it('should return paginated list of cities', async () => {
      ...
      const page = 1;
      const limit = 10;
      cityRepository.findPaginatedList.mockResolvedValue(mockPaginatedResult);

      // Act
      const result = await useCase.execute(term, page, limit);

      // Assert
      expect(cityRepository.findPaginatedList).toHaveBeenCalledWith(
        term,
        page,
        limit,
      );
    ...
    it('should handle different page and limit values', async () => {
      ...
      cityRepository.findPaginatedList.mockResolvedValue(customResult);
    ...
    it('should handle empty results', async () => {
      ...
      cityRepository.findPaginatedList.mockResolvedValue(emptyResult);
    ...
    it('should handle repository errors', async () => {
      ...
      cityRepository.findPaginatedList.mockRejectedValue(mockError);
    ...
    it('should handle large page numbers', async () => {
      ...
      cityRepository.findPaginatedList.mockResolvedValue(largePageResult);
    ...
    it('should handle zero limit', async () => {
      ...
      cityRepository.findPaginatedList.mockResolvedValue(zeroLimitResult);
