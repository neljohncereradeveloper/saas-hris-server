...
describe('CreateCityUseCase', () => {
  ...
  const mockCreateCommand: CreateCityCommand = {
    desc1: 'Manila',
  };
  ...
  beforeEach(async () => {
    ...
    useCase = module.get<CreateCityUseCase>(CreateCityUseCase);
  ...
  describe('execute', () => {
    it('should successfully create a city and log the activity', async () => {
      // Arrange
      const mockManager = {};
      ...
      cityRepository.create.mockResolvedValue(mockCity);
      ...
      expect(cityRepository.create).toHaveBeenCalledWith(
        new City(mockCreateCommand),
        mockManager,
      );
      expect(activityLogRepository.create).toHaveBeenCalledWith(
        expect.objectContaining({
          action: CONSTANTS_LOG_ACTION.CREATE_CITY,
          ...
          description: `Created new city: ${mockCity.desc1}`,
    ...
    it('should handle creation failure and log error', async () => {
      ...
      cityRepository.create.mockRejectedValue(mockError);
      activityLogRepository.create.mockResolvedValue({} as ActivityLog);
      ...
      expect(activityLogRepository.create).toHaveBeenCalledWith(
        expect.objectContaining({
          ...
          description: `Failed to create city: ${mockCreateCommand.desc1}`,
          ipAddress: mockRequestInfo.ipAddress,
          userAgent: mockRequestInfo.userAgent,
          sessionId: mockRequestInfo.sessionId,
          username: mockRequestInfo.username,
    ...
    it('should handle unknown error types', async () => {
      ...
      cityRepository.create.mockRejectedValue('Unknown error');
      activityLogRepository.create.mockResolvedValue({} as ActivityLog);
