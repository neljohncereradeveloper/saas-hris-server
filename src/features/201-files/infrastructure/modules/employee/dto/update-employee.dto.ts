...
export class UpdateEmployeeDto {
  ...
  @RequiredStringValidation({
    ...
    pattern: /^[a-zA-Z0-9\s\-_&.,()]+$/,
    patternMessage:
      'Employee status can only contain letters, numbers, spaces, and basic punctuation',
    sanitize: true,
  })
  ...
  @RequiredStringValidation({
    ...
    pattern: /^[a-zA-Z0-9\s\-_&.,()]+$/,
    patternMessage:
      'Home address street can only contain letters, numbers, spaces, and basic punctuation',
    sanitize: true,
  })
  ...
  @RequiredStringValidation({
    ...
    pattern: /^[a-zA-Z0-9\s\-_&.,()]+$/,
    patternMessage:
      'Home address city can only contain letters, numbers, spaces, and basic punctuation',
    sanitize: true,
  })
  ...
  @RequiredStringValidation({
    ...
    pattern: /^[a-zA-Z0-9\s\-_&.,()]+$/,
    patternMessage:
      'Home address province can only contain letters, numbers, spaces, and basic punctuation',
    sanitize: true,
  })
  ...
  @RequiredStringValidation({
    ...
    pattern: /^[a-zA-Z0-9\s\-_&.,()]+$/,
    patternMessage:
      'Home address zip code can only contain letters, numbers, spaces, and basic punctuation',
    sanitize: true,
  })
